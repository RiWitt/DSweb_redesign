...
export const ui = {
  sk: {
    ...
    tickerLabel: "Kontaktné údaje",
    skipToContent: "Preskočiť na obsah",
    ogImageAlt: "Poschodová elektrická jednotka ZSSK na stanici",
    menuLabel: "Menu",
    ...
    ctaHeading: "Porozprávajme sa o vašom projekte.",
    ctaBodyHome:
      "Radi si vypočujeme, čo riešite, a spoločne nájdeme najlepší spôsob, ako vám pomôcť.",
    ctaBodyAbout:
      "Radi si vypočujeme, na čom pracujete, a nájdeme najlepší spôsob, ako pomôcť.",
  ...
  en: {
    ...
    tickerLabel: "Contact details",
    skipToContent: "Skip to content",
    ogImageAlt: "A double-deck ZSSK electric multiple unit at a station",
    menuLabel: "Menu",
    ...
    ctaBodyHome:
      "We'd love to hear what you're working on, and find the best way we can help.",
    ctaBodyAbout:
      "We'd love to hear what you're working on, and find the best way we can help.",
    ...
    footTagline:
      "Tailored communication and information solutions for your business.",
